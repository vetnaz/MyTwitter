...
import com.example.blog_2.repos.UserRepo;
import com.example.blog_2.securingweb.WebSecurityConfig;
    ...
    private void sendMessage(User user) {
        if (!StringUtils.isEmpty(user.getEmail())){
            String message = String.format(
                    "Hello %s \n" +
                            "Welcome to MyTwitter. Please visit next link http://localhost:8081/activate/%s",
                    user.getUsername(),
